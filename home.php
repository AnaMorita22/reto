<?php
    ...
    $userId = $_SESSION['user_id']; // Obtener el ID del usuario almacenado en la sesión
    ...
    $query = "SELECT fecha_orden, documento_orden, numero_orden FROM ordenes WHERE user_id = $1"; // Asegúrate de que el campo user_id es el correcto
